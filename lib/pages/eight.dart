...
class _SevenState extends State<Eight> {
  ...
  TextEditingController bank_title = TextEditingController();
  TextEditingController acc_ttitle = TextEditingController();
 TextEditingController acc_no = TextEditingController();
  TextEditingController acc_iban = TextEditingController();
  ...
  // }}
    ...
    Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: Color.fromARGB(255, 18, 29, 19),
        ),
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Container(
                            ...
                            child: ListTile(
                              ...
                              title: Text("${snapshot.data[index].bank_title}",
                                  style: TextStyle(
                                      color: Colors.grey[800],
                                      fontWeight: FontWeight.bold)),
                              subtitle: Text("${snapshot.data[index].acc_ttitle}"),
                              trailing: Column(children: [

                                Text("${snapshot.data[index].acc_no}"),
                             Text("${snapshot.data[index].acc_iban}"),
                                SizedBox(
                                  height: 5,
                                ),
                              ]),
