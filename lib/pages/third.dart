        ...
        padding: EdgeInsets.only(top: MediaQuery.of(context).size.height*0.52,left: MediaQuery.of(context).size.width*0.12),
         child: Row(
           children: [
             ...
             Text("3",style: TextStyle(fontSize: 45,fontWeight: FontWeight.bold,color: Colors.white),),
         ...
         Padding(
          ...
          Padding(
           ...
           child: Text("Christain Loby showing us his new\nsummer beach wears.",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white,)),
         ),
         Padding(
